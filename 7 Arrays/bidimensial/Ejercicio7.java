/**
 * Ejercicio 7 Mejora el juego Busca el tesoro de tal forma que si hay una mina a una casilla de distancia,
    ...
    do {
      ...
      switch(cuadrante[x][y]) {
        case VACIO:
          ...
          if ((x == minaX -1) || (x == minaX +1) || (x == minaX -2) || (x == minaX +2) && (y == minaY -1) || (y == minaY +1) || (y == minaY -2) || (y == minaY +2)){
